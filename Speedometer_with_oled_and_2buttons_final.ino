 ...
 * baseed on scale speedometer by @rwissbaum9849 on youtube channel "HO Scale Rio Grande in the San Luis Valley"
 * also includes oled code from robojax
 */

 //========== Customization ==================================

#include <Button.h> // don't forget to include this library in the IDE
...
#define O    48
#define S    64
#define HO   87.1 // ignore decimal in display
#define OO   76
#define TT   120
#define Nb   148 // N british
#define Ne   160 // N european
#define Z    220 
...
//set some initial values that aren't constants
...
vString = "0.0";
  ...
  // maybe set up the inital display
...
if (button1.pressed()) { 
        // if speed unit is changed then recalc speed to match 
...
// rethink display
// very time we send to the display update all elements
...
void oled_display2(float speed, String unitsString, float scale, String text) {
  ...
  scaleString = String(scaleA[PC],0); // display scale with no desimal places as it looks better
